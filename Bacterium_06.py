...
def main():
    ...
    while not donePlaying:
        ...
        if not donePlaying:
            Finalscore, Lives = game(1, Finalscore, Lives)
            if Lives > 0:
                Finalscore, Lives = game(2, Finalscore, Lives)
                if Lives > 0:
                    Finalscore, Lives = game(3, Finalscore, Lives)
                    if Lives > 0:
                        Finalscore, Lives = game(4, Finalscore, Lives)
        if Lives > 0:
            alive = True
